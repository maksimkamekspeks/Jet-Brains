...
def logic(sequence, operators):
    ...
    while True:
        ...
        if sequence_1[j] in pm:
            ...
            if sequence_1[j + 1].isdigit() or sequence_1[j + 1] in md or sequence_1[j + 1] in pars or sequence_1[
                j + 1] == "^":
                temp_seq.append("".join(marks))
                marks.clear()
        if sequence_1[j] in md:
            marks.append(sequence_1[j])
            if sequence_1[j + 1].isdigit() or sequence_1[j + 1] in pm or sequence_1[j + 1] in pars or sequence_1[
                j + 1] == "^":
                temp_seq.append("".join(marks))
                marks.clear()
